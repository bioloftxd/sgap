...
@section("title", "EDITAR COLETA DE OVOS")
...
@section("content")
    ...
    <div class="mdl-grid">
        ...
        <div class="mdl-cell mdl-cell--11-col">
            ...
            <form method="POST" action="{{action('ControlaColetaOvo@update',["id"=>$dados->id])}}">
                {{csrf_field()}}
                {{method_field("PUT")}}
