...
@section("content")
    ...
    <div class="mdl-grid">
        ...
        <div class="mdl-cell mdl-cell--11-col">
            ...
            <form method="POST" action="{{action('ControlaUsuario@update',["id" => $usuario->id])}}">
                ...
                <div class="mdl-grid">
                    ...
                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--6-col-desktop">
                        <input class="mdl-textfield__input" type="text" id="nomeCompleto" autofocus
                               value="{{$usuario->nome}}"
                               name="nome">
                    ...
                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--4-col-desktop mdl-cell--4-col-phone mdl-cell--2-col-tablet">
                    ...
                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--4-col-desktop mdl-cell--4-col-phone mdl-cell--3-col-tablet">
            ...
            <form action="{{action("ControlaUsuario@destroy", ["id" => $usuario->id])}}"
                  method="POST">
                {{csrf_field()}}
                {{method_field('DELETE')}}
                <div class="mdl-grid">
                    ...
                    <button type="submit"
                            class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent mdl-cell--4-col-desktop mdl-cell--4-col-phone mdl-cell--8-col-tablet"
