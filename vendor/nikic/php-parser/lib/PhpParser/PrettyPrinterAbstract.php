...
abstract class PrettyPrinterAbstract
{
    ...
    /**
     * Pretty prints a file of statements (_includes the opening <?php tag if it is required).
     *
     * @param Node[] $stmts Array of statements
     *
     * @return string Pretty printed statements
     ...
     *
     * The result _includes a leading newline and one level of indentation (same as pStmts).
     *
     * @param Node[] $nodes         Array of Nodes to be printed
